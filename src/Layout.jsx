      ...
      {flyoutOpen && (
        ...
        >
          <div
            ...
            style={{ background: "var(--app-surface-solid, #0f172a)", border: "1px solid var(--app-border, rgba(255,255,255,0.1))" }}
          >
...
function DropdownNav({ currentPageName, userEmail }) {
  ...
  const NAV_GROUPS = useMemo(() => buildNavGroups(t, userEmail), [t, userEmail]);
    ...
    <div ref={navRef} className="hidden md:flex items-center gap-1" style={{ position: "relative", zIndex: 999 }}>
      {NAV_GROUPS.map((group) => (
        <div
          ...
          onFocus={() => handleMouseEnter(group.label)}
            ...
            >
              ...
              >
                ...
                {(group.pages || []).length > 0 && group.subGroups && (
                  <div className="my-1 mx-3 border-t" style={{ borderColor: "var(--app-border, rgba(255,255,255,0.1))" }} />
                )}
...
function LanguageSwitcher() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 rounded-2xl shadow-2xl z-50 py-1 overflow-hidden" style={{ background: "var(--app-surface-solid, #0f172a)", border: "1px solid var(--app-border, rgba(255,255,255,0.1))", minWidth: 140 }}>
          {LANGUAGES.map(l => (
...
export default function Layout({ children, currentPageName }) {
  ...
  const navGroups = useMemo(() => buildNavGroups(t, devEmail), [t, devEmail]);
  ...
  return (
    <SuspensionGate user={layoutUser}>
      <div className="min-h-screen flex flex-col" style={{ background: "var(--app-bg, #090d16)", color: "var(--app-text, #ffffff)" }}>
        <ThemeProvider />
        ...
        {showTopNav && (
          <nav
            ...
            style={{ borderBottom: "1px solid var(--app-border, rgba(255,255,255,0.1))", background: "var(--app-nav-bg, rgba(15,23,42,0.8))", paddingTop: "calc(0.75rem + env(safe-area-inset-top))", paddingBottom: "0.75rem" }}
          >
            <div className="flex items-center gap-2 flex-1">
              {isChild && (
                <button
                  ...
                  style={{ minWidth: 44, minHeight: 44, color: "var(--app-text, #ffffff)" }}
                >
            ...
            <div className="flex items-center gap-2 flex-1 justify-end">
              ...
              >
                <span className={`block w-5 h-0.5 transition-all ${mobileMenuOpen ? "rotate-45 translate-y-1.5" : ""}`} style={{ background: "var(--app-text, #ffffff)" }} />
                <span className={`block w-5 h-0.5 transition-all ${mobileMenuOpen ? "opacity-0" : ""}`} style={{ background: "var(--app-text, #ffffff)" }} />
                <span className={`block w-5 h-0.5 transition-all ${mobileMenuOpen ? "-rotate-45 -translate-y-1.5" : ""}`} style={{ background: "var(--app-text, #ffffff)" }} />
              </button>
        ...
        <div className="w-full text-center py-3 text-xs opacity-30 flex flex-col items-center gap-2" style={{ color: "var(--app-text, #ffffff)" }}>
        ...
        <div
          ...
          style={{
            ...
            borderLeft: "1px solid var(--app-border, rgba(255,255,255,0.1))",
                ...
                <div key={group.label}>
                  <button
                    ...
                    style={{
                      ...
                      color: isActive ? "rgb(167,139,250)" : "var(--app-text, #ffffff)",
                    }}
                  >
                    {group.label}
                  ...
                  {mobileOpenGroup === group.label && (
                    <div className="ml-2 mt-1 space-y-0.5 mb-2">
                      ...
                      {group.subGroups && (group.pages || []).length > 0 && (
                        <div className="my-1 mx-2 border-t" style={{ borderColor: "var(--app-border, rgba(255,255,255,0.1))" }} />
                      )}
                      {(group.pages || []).map(({ label, icon: Icon, page }) => (
                        <Link key={page} to={createPageUrl(page)} onClick={() => { setMobileMenuOpen(false); setMobileOpenGroup(null); }}>
